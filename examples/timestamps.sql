...
SELECT generate_series('2016-01-03 06:30:40'::timestamp, '2016-01-05 12:30:40', '7 hours 5 minutes'::interval) OVER ();
...
SELECT generate_series('2020-01-01'::timestamp, '2021-01-01'::timestamp, interval '1 month') OVER();
SELECT generate_series('2020-01-01'::timestamp, '2021-01-01'::timestamp, intervalYM '1 month') OVER();
